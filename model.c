...
void init_entities(World* world){
	...
	//Load the mars object and texture.
	...
	//Load the asteroid object and texture.
	load_model("objects\\asteroid.obj", &world->asteroid.model);
	world->asteroid.texture = load_texture("textures\\asteroid.png");
	scale_model (&world->asteroid.model, 6.9, 6.9, 6.9);
